...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/image-renamer-with-exif"
...
OUTPUT_NAME="image-renamer-with-exif"
...
echo "  ./image-renamer-with-exif"
echo "  ./image-renamer-with-exif --dir ./photos --ext jpg"
echo "  ./image-renamer-with-exif --dir ./photos --recursive"
echo "  ./image-renamer-with-exif --dir ./photos --dry-run"
echo "  ./image-renamer-with-exif --dir ./photos --use-file-modtime"
echo "  ./image-renamer-with-exif --dir ./photos --verbose"
