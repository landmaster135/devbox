...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/json-timestamp-modifier"
...
OUTPUT_NAME="json-timestamp-modifier"
...
echo "  ./json-timestamp-modifier -file new_data.json"
echo "  ./json-timestamp-modifier -file data.json"
echo "  ./json-timestamp-modifier -file data.json -key updated_at"
