...
echo "  ./bin/notion-sync -token "your_token" -page-id "page_id" -markdown "# Hello World" -endpoint-url "http://localhost:8080/task/patch""
echo "  ./bin/notion-sync -t "your_token" -p "page_id" -m "# Hello World" -u "http://localhost:8080/task/patch""
echo "  ./bin/notion-sync "your_token" "# Hello World" "http://localhost:8080/task/patch" -page-id "page_id""
