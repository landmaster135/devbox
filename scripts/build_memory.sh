...
echo "  ./bin/memory -operation create-entities -entities '[{"name":"John","entityType":"person","observations":["speaks English","likes coffee"]}]'"
echo "  ./bin/memory -operation create-entities -entities '[{"name":"John","entityType":"person","observations":["speaks English"]},{"name":"Company","entityType":"organization","observations":["tech company","located in Tokyo"]}]'"
echo "  ./bin/memory -o create-entities -e '[{"name":"Alice","entityType":"person","observations":["speaks Japanese","works remotely"]}]'"
