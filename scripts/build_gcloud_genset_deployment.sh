...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/gcloud-genset-deployment"
...
OUTPUT_NAME="gcloud-genset-deployment"
...
echo "  go run ./cmd/cli/gcloud-genset-deployment \\"
echo "  --operation=list-deployments \\"
echo "  --project=my-sample-project"
