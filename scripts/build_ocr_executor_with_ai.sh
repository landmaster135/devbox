...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/ocr-executor-with-ai"
...
OUTPUT_NAME="ocr-executor-with-ai"
...
echo "  ./bin/ocr-executor-with-ai -path /path/to/image.webp -ai-type gemini -api-key "your-api-key""
echo "  ./bin/ocr-executor-with-ai -path /path/to/image.webp -ai-type vertex -project "your-project-id""
echo "  ./bin/ocr-executor-with-ai -path /path/to/directory -recursive -ai-type gemini -api-key "your-api-key""
