...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/gcloud-genset-secret"
...
OUTPUT_NAME="gcloud-genset-secret"
...
echo "  $ go run ./cmd/cli/gcloud-genset-secret \\"
echo "  -operation create-and-add-secret-version \\"
echo "  -secret-name SECRET_NAME \\"
echo "  -secret-value 'SECRET_PASSWORD'"
