...
echo "  ./movie-converter -input video.mp4"
echo "  ./movie-converter -input animation.gif"
echo "  ./movie-converter -input video.mp4 -output animation.gif"
echo "  ./movie-converter -help"
