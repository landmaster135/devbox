...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/gcloud-genset-cloudsql"
...
OUTPUT_NAME="gcloud-genset-cloudsql"
...
echo "  go run ./cmd/cli/gcloud-genset-cloudsql \\"
echo "  -operation patch-deletion-protection \\"
echo "  -instance-name my-sql-instance \\"
echo "  -deletion-protection-mode disable"
