...
echo "  ./json-modifier -file data.json -key name -get"
echo "  ./json-modifier -file data.json -get-all"
echo "  ./json-modifier -file data.json -key count -set 42"
