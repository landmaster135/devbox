...
echo "  go run ./cmd/cli/withings \\"
echo "  -operation auth-url \\"
echo "  -client-id \"YOUR_CLIENT_ID\" \\"
echo "  -redirect-uri \"https://yourapp.example/oauth/callback\" \\"
echo "  -scope \"user.metrics,user.activity\" \\"
echo "  -state \"random_state_value\""
