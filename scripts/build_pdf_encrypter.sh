...
echo "  ./pdf-encrypter -mode encrypt -in plain.pdf -out locked.pdf -upw reader -opw owner"
echo "  ./pdf-encrypter -mode decrypt -in locked.pdf -out plain.pdf -opw owner"
