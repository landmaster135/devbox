...
echo "  go run ./cmd/cli/steam --operation games --steam-api-key ABCD1234567890 --steam-id 76561198000000000"
echo "  go run ./cmd/cli/steam --operation game-stats --steam-api-key ABCD1234567890 --steam-id 76561198000000000"
echo "  go run ./cmd/cli/steam -o games -k ABCD1234567890 -s 76561198000000000"
echo "  go run ./cmd/cli/steam -o game-stats -k ABCD1234567890 -s 76561198000000000"
