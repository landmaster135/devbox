...
echo "  go run ./cmd/cli/anilist -operation query-anime -username your_username"
echo "  go run ./cmd/cli/anilist -operation query-anime -user-id 123456"
echo "  go run ./cmd/cli/anilist -o query-anime -u your_username"
