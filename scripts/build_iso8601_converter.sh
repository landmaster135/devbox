...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/iso8601-converter"
...
echo "  ./iso8601-converter --to-iso --input 1619712000"
echo "  ./iso8601-converter --to-unix --input \"2021-04-30T00:00:00Z\""
echo "  ./iso8601-converter --to-unix --input \"2021-04-30\""
echo "  ./iso8601-converter --to-unix --is-jst --input \"2021-04-30\""
