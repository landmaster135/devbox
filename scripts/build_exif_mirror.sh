...
echo "  ./exif-mirror --source-dir ./originals --target-dir ./converted --source-ext jpg --target-ext webp"
echo "  ./exif-mirror --source-dir ./photos --target-dir ./photos --source-ext png --target-ext webp --recursive"
echo "  ./exif-mirror --source-dir ./src --target-dir ./dst --source-ext jpg --target-ext png --dry-run"
echo "  ./exif-mirror --source-dir ./src --target-dir ./dst --source-ext jpg --target-ext webp --verbose"
