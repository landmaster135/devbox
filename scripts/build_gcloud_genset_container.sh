...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/gcloud-genset-container"
...
OUTPUT_NAME="gcloud-genset-container"
...
echo "  go run ./cmd/cli/gcloud-genset-container \\"
echo "  -operation deploy-cloud-run-container \\"
echo "  -service-name MY_SERVICE \\"
echo "  -project-id MY_PROJECT_ID \\"
echo "  -region asia-northeast1 \\"
echo "  -timeout 45m \\"
echo "  -run-service-account my-svc@my-project.iam.gserviceaccount.com \\"
echo "  -allow-unauthenticated=false"
