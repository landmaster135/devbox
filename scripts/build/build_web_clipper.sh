...
echo "Usage example:"
echo "  ./bin/web-clipper --operation=patch-markdown --target-title=\"OpenAI Blog\" --target-url=\"https://openai.com/blog\" --src-markdown-file=./in.md --out-file-path=./out.md --top-heading-level=2"
