...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/gcloud-genset-billing"
...
OUTPUT_NAME="gcloud-genset-billing"
...
echo "  go run ./cmd/cli/gcloud-genset-billing \\"
echo "  -operation list-budgets \\"
echo "  -limit 20 \\"
echo "  -billing-account 0000-AAAA-BBBB"
