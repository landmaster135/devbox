...
echo '  go run ./cmd/cli/memos-utility \'
echo '  -operation=create-web-clip \'
echo '  -base-url="$MEMOS_BASE_URL" \'
echo '  -api-token="$MEMOS_TOKEN" \'
echo "  -content-file=/tmp/web-summary-20240719-231059-palworld-steam-dedicated-server.md"
