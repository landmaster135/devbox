...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/gcloud-genset-logging"
...
OUTPUT_NAME="gcloud-genset-logging"
...
echo "  $ go run ./cmd/cli/gcloud-genset-logging \\"
echo "  -operation logging-read \\"
echo "  -severity ERROR \\"
echo "  -resource-type gce_instance \\"
echo "  -limit 25 \\"
