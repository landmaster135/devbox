...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/gcloud-genset-ai"
...
echo "  $ go run ./cmd/cli/gcloud-genset-ai \\"
echo "  -operation undeploy-processor-version \\"
echo "  -region us-central1 \\"
echo "  -project-number 123456789012 \\"
echo "  -processor-id 1234567890abcdef \\"
echo "  -version-id 20240901"
