...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/gcloud-genset-dns"
...
echo "  $ go run ./cmd/cli/gcloud-genset-dns \\"
echo "  -operation managed-zones-list \\"
echo "  -project my-project \\"
echo "  -filter \"name:example\" \\"
echo "  -limit 50 \\"
echo "  -uri"
