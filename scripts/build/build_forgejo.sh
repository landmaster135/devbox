...
echo "  ./forgejo -operation \"repo list\" -forgejo-host https://codeberg.org -forgejo-username yourname -forgejo-token xxx -json"
echo "  ./forgejo project list -forgejo-host https://codeberg.org -forgejo-username yourname -forgejo-token xxx"
