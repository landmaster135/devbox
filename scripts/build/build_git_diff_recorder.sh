...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/git-diff-recorder"
...
echo "  ./git-diff-recorder --output-dir /path/to/output"
echo "  ./git-diff-recorder --output-dir /path/to/output --staged-only"
