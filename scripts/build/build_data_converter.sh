...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/data-converter"
...
echo "  go run ./cmd/cli/data-converter \\"
echo "  -input-file-path ./users.json \\"
echo "  -output-file-path ./users.csv"
