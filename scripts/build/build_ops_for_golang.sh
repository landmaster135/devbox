...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/ops-for-golang"
...
echo "  ./bin/ops-for-golang -ops test-coverage -directory /path/to/project"
echo "  ./bin/ops-for-golang -o test-coverage -d /path/to/project"
echo "  ./bin/ops-for-golang -ops test-coverage -directory /path/to/project -grep_pattern "PASS""
echo "  ./bin/ops-for-golang -o test-coverage -d /path/to/project -g "PASS""
