...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/gcloud-genset-scheduler"
...
OUTPUT_NAME="gcloud-genset-scheduler"
...
echo "  go run ./cmd/cli/gcloud-genset-scheduler -operation create-http-job \\"
echo "  -job-name nightly-http-call \\"
echo "  -project-id SAMPLE_PROJECT \\"
echo "  -http-method POST \\"
echo "  -service-url https://asia-northeast1-example.run.app/hook \\"
echo "  -headers \"Content-Type=application/json\" \\"
echo "  -message-body '{\"task\":\"nightly\"}' \\"
echo "  -oidc-service-account-email cron-runner@example.iam.gserviceaccount.com"
