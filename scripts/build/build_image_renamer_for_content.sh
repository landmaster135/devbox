...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/image-renamer-for-content"
...
OUTPUT_NAME="image-renamer-for-content"
...
echo "  go run ./cmd/cli/image-renamer-for-content -content MA -name"
echo "  go run ./cmd/cli/image-renamer-for-content -src ./images -content CT -time -suffix final -delimiter \"-\""
echo "  go run ./cmd/cli/image-renamer-for-content -content BLOG -name -start 5 -r"
echo "  go run ./cmd/cli/image-renamer-for-content -content MA -name -workers 4"
