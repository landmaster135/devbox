...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/arithmetic-calculator"
...
OUTPUT_NAME="arithmetic-calculator"
...
echo "  ./bin/arithmetic-calculator -operation add -x 10 -y 5"
echo "  ./bin/arithmetic-calculator -o add -x 10 -y 5"
echo "  ./bin/arithmetic-calculator -o add 10 5  # 位置引数"
echo "  ./bin/arithmetic-calculator -operation subtract -x 10 -y 3"
echo "  ./bin/arithmetic-calculator -operation multiply -x 4 -y 7"
echo "  ./bin/arithmetic-calculator -operation divide -x 20 -y 4"
