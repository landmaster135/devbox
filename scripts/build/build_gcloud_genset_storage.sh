...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/gcloud-genset-storage"
...
OUTPUT_NAME="gcloud-genset-storage"
...
echo "  go run ./cmd/cli/gcloud-genset-storage \\"
echo "  -operation upload-files \\"
echo "  -local-path ./build/output \\"
echo "  -bucket-url gs://my-artifact-bucket/releases/"
