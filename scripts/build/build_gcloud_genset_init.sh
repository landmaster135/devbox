...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/gcloud-genset-init"
...
OUTPUT_NAME="gcloud-genset-init"
...
echo "  $ go run ./cmd/cli/gcloud-genset-init \\"
echo "  -operation auth-login \\"
echo "  -project-id MY_PROJECT_123 \\"
echo "  -additional-args '--quiet'"
