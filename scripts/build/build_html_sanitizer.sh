...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/html-sanitizer"
...
echo "  go run ./cmd/cli/html-sanitizer --input-file ./sample_data/sample.html --output-file ./tmp/sanitized.html"
