...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/json-file-merger"
...
echo "  ./pkg/bin/linux_amd64/json-file-merger -dir ./sample_data -key pc_stats -output output.json"
echo "  ./pkg/bin/win_amd64/json-file-merger.exe -dir ./sample_data -key pc_stats -output output.json"
