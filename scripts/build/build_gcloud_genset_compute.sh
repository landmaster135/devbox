...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/gcloud-genset-compute"
...
OUTPUT_NAME="gcloud-genset-compute"
...
echo "  go run ./cmd/cli/gcloud-genset-compute \\" 
echo "  -operation create-gce-instance \\" 
echo "  -instance-name my-vm \\" 
