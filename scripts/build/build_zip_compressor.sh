...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/zip-compressor"
...
echo "  ./bin/zip-compressor -operation compress -path /home/user/document.txt"
echo "  ./bin/zip-compressor -o compress -p /home/user/document.txt"
echo "  ./bin/zip-compressor compress /home/user/document.txt  # 位置引数"
