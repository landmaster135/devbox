...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/gcloud-genset-iam"
...
echo "  $ go run ./cmd/cli/gcloud-genset-iam \\"
echo "  -operation create-service-account \\"
echo "  -service-account-id SERVICE_ACCOUNT_ID \\"
echo "  -project-id MY_PROJECT \\"
