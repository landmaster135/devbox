...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/coverage-badge"
...
echo "  go run cmd/cli/coverage-badge/main.go -operation=create-badge -coverage-file=coverage.out"
echo "  go run cmd/cli/coverage-badge/main.go -operation=patch-badge -target-file=README.md -coverage-file=coverage.out"
