...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/gcloud-genset-monitoring"
...
OUTPUT_NAME="gcloud-genset-monitoring"
...
echo "  $ go run ./cmd/cli/gcloud-genset-monitoring \\"
echo "  -operation list-dashboards \\"
echo "  -project my-project \\"
echo "  -filter 'displayName:test' \\"
echo "  -page-size 20 \\"
echo "  -sort-by displayName \\"
echo "  -limit 50 \\"
echo "  -format json"
