...
echo "  ./bin/mcp-remote https://remote.mcp.server/sse"
echo "  ./bin/mcp-remote https://remote.mcp.server/sse -p 9696 -H "Authorization:Bearer ${TOKEN}""
echo "  ./bin/mcp-remote https://remote.mcp.server/sse -d -t sse-only"
echo "  ./bin/mcp-remote http://localhost:8080/mcp -d --allow-http"
