...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/weather-notificator"
...
OUTPUT_NAME="weather-notificator"
...
echo "  ./weather-notificator \"
echo "  -api-key your_openweather_api_key \"
echo "  -city Tokyo \"
echo "  -max-days 3 \"
echo "  -webhook-url https://discord.com/api/webhooks/123456789/abcdefg"
