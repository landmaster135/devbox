...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/git-info-retriever"
...
OUTPUT_NAME="git-info-retriever"
...
echo "  go run ./cmd/cli/git-info-retriever/main.go -service github -token ghp_xxxxxxxxxxxxxxxxxxxx"
echo "  go run ./cmd/cli/git-info-retriever/main.go -service github -token ghp_xxxxxxxxxxxxxxxxxxxx -save-file ./output.json"
echo "  go run ./cmd/cli/git-info-retriever/main.go -service github -token ghp_xxxxxxxxxxxxxxxxxxxx -save-file ./results/github-repos.json"
echo "  go run ./cmd/cli/git-info-retriever/main.go -help"
