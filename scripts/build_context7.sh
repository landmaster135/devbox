...
echo "  ./context7 search react"
echo "  ./context7 search vue"
echo "  ./context7 search typescript"
echo "  ./context7 docs /context7/react_dev"
echo "  ./context7 docs /context7/react_dev -topic=hooks"
echo "  ./context7 docs /context7/react_dev -tokens=2000"
echo "  ./context7 docs /vercel/next.js -topic=routing -tokens=3000"
echo "  ./context7 search "react router""
echo "  ./context7 docs /context7/reactrouter"
echo "  ./context7 docs /context7/reactrouter -topic=navigation -tokens=5000"
echo "  ./context7 docs /nonexistent/library"
echo "  ./context7 docs invalid-format"
