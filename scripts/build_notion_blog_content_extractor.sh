...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/notion-blog-content-extractor"
...
OUTPUT_NAME="notion-blog-content-extractor"
...
echo "  ./bin/notion-blog-content-extractor -src-dir=./blog-drafts -dest-dir=./extracted-content"
echo "  ./bin/notion-blog-content-extractor -src-dir=/home/user/documents/blogs -dest-dir=/home/user/output"
