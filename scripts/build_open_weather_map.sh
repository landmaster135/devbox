...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/open-weather-map"
...
echo "  ./open-weather-map -k abc123 -c "Tokyo,JP" -d 3"
echo "  ./open-weather-map -api-key abc123 -city "London,UK" -max-days 5"
echo "  ./open-weather-map abc123 "New York,US" 2"
