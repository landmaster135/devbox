...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/image-trim-describer"
...
OUTPUT_NAME="image-trim-describer"
...
echo "  ./image-trim-describer -src ./photos"
echo "  ./image-trim-describer -src ./photos -out ./output -arc ./archive -move"
