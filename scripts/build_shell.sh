...
echo "  go run ./cmd/cli/shell -operation=execute -workdir=app -- bash -lc \"ls -a\""
echo "  go run ./cmd/cli/shell -operation=execute -workdir=. -- bash -lc \"ls -a | grep .git\""
echo "  go run ./cmd/cli/shell -operation=execute \\"
echo "  -command bash -command -lc -command \"ls -a\" \\"
echo "  -base-dir=. -workdir=."
