...
# ビルド対象のディレクトリ
CMD_DIR="cmd/cli/base64-extractor"
...
echo "  ./base64-extractor -path=/path/to/image.jpg"
echo "  ./base64-extractor -path=/path/to/images/"
echo "  ./base64-extractor -path=/path/to/images/ -recursive=false"
echo "  ./base64-extractor -path=/path/to/images/ -output-format=json"
