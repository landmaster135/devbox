...
echo [Notice] Google Cloud OAuth Authentication is required.
...
set /p project="Input Project ID to request Vertex AI API: "

echo --- プログラムを実行します ---
.\pkg\bin\cli\win_amd64\ocr-executor-with-ai.exe -path "%path%" -ai-type vertex -project %project% -prompt "%prompt%"
echo.
