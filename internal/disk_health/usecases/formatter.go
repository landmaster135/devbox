...
func (s *Service) FormatDmesgText(assessment domain.DmesgAssessment, verbose bool) string {
	var builder strings.Builder
	builder.WriteString(fmt.Sprintf("status: %s\n", assessment.Status))
	builder.WriteString(fmt.Sprintf("score: %d\n", assessment.Score))
	builder.WriteString(fmt.Sprintf("summary: %s\n", assessment.Summary))
...
func (s *Service) FormatDmesgJSON(assessment domain.DmesgAssessment, verbose bool) (string, error) {
	if !verbose {
