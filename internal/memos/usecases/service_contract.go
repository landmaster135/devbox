...
type MemoService interface {
	...
	ListMemos(ctx context.Context, pageSize int, pageToken string, state string, orderBy string, filter string, anyContents []string, allContents []string, allTags []string) (*ListMemosOutput, error)
...
type MockMemoService struct {
	...
	ListMemosFunc         func(ctx context.Context, pageSize int, pageToken string, state string, orderBy string, filter string, anyContents []string, allContents []string, allTags []string) (*ListMemosOutput, error)
...
func (m *MockMemoService) ListMemos(ctx context.Context, pageSize int, pageToken string, state string, orderBy string, filter string, anyContents []string, allContents []string, allTags []string) (*ListMemosOutput, error) {
	if m.ListMemosFunc != nil {
		return m.ListMemosFunc(ctx, pageSize, pageToken, state, orderBy, filter, anyContents, allContents, allTags)
	}
	return nil, nil
}
