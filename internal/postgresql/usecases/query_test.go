...
func TestFetchTableWithComments_Normal(t *testing.T) {
	...
	table, err := service.fetchTableWithComments(ctx, "users")
...
func TestFetchPrimaryKeys_Normal(t *testing.T) {
	...
	// 関数を実行
	ctx := context.Background()
	primaryKeys, err := service.fetchPrimaryKeys(ctx, "users")
...
func TestFetchUniqueKeys_Normal(t *testing.T) {
	...
	// 関数を実行
	ctx := context.Background()
	uniqueKeys, err := service.fetchUniqueKeys(ctx, "users")
...
func TestFetchForeignKeys_Normal(t *testing.T) {
	...
	// 関数を実行
	ctx := context.Background()
	foreignKeys, err := service.fetchForeignKeys(ctx, "users")
...
func TestFetchTableColumns_Normal(t *testing.T) {
	...
	// 関数を実行
	ctx := context.Background()
	columns, err := service.fetchTableColumns(ctx, "users")
...
func TestFetchTableIndexes_Normal(t *testing.T) {
	...
	// 関数を実行
	ctx := context.Background()
	indexes, err := service.fetchTableIndexes(ctx, "users")
...
func TestGetTableDetail_Normal(t *testing.T) {
	...
	// 関数を実行
	ctx := context.Background()
	detail, err := service.GetTableDetail(ctx, "users")
...
func TestGetAllTableSummaries_Normal(t *testing.T) {
	...
	// 関数を実行
	ctx := context.Background()
	tables, err := service.GetAllTableSummaries(ctx)
