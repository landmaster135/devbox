...
import (
	...
	calculator "github.com/landmaster135/devbox/internal/datetime_calculator/usecases/calculator"
)
...
type DatetimeCalculatorService struct {
	calculator *calculator.DatetimeCalculator
...
func (s *DatetimeCalculatorService) GetCalculator() *calculator.DatetimeCalculator {
	return s.calculator
}
