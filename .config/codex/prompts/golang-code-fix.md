Fix code format in Golang.

<detailed_sequence_of_steps>
1. If the files to fix are not provided from user, ask those files to user.
2. Fix only the naming conventions while keeping the processing logic intact.
3. Eliminate the anti-patterns while keeping the processing logic intact.
