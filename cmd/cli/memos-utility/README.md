...
- `-operation=create-clips`
  - `-content-dir` 配下の全ファイルが以下のいずれかである必要があります。
    - `web-summary-YYYYMMDD-hhmmss-<slug>.md`
    - `movie-summary-YYYYMMDD-hhmmss-<slug>.md`
...
{
  "operation": "create-clips",
  "contentDir": "/tmp/clips",
  "attachmentDir": "/tmp/attachments",
  "total": 2,
  "clips": [
    {
      "operation": "create-movie-clip",
      "displayTime": "2026-03-19T05:57:16+09:00"
    },
    {
      "operation": "create-web-clip",
