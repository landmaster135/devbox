...
// ##          Handlers                                          ##
// #==============================================================#
func handleGetCurrentTimezone(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func handleConvertTimezone(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func handleListAvailableTimezones(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	service := usecases.NewTimezoneService()
...
// ##          Servers                                           ##
// #==============================================================#
func setTimezoneToolsServer(s *server.MCPServer) *server.MCPServer {
	// 現在時刻を取得するツール
	...
	s.AddTool(getCurrentTool, handleGetCurrentTimezone)
...
func createTimezoneServer() *server.MCPServer {
